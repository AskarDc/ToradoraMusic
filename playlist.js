    ...
    run: async function (client, message, args) {
        ...
        if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            try {
                ...
                let thing = new MessageEmbed()
                    .setAuthor("Playlist has been added to queue", "https://media.discordapp.net/attachments/832228029987946496/833329599412305930/MusicArrow.gif")
        ...
        async function handleVideo(video, message, channel, playlist = false) {
            ...
            if (!serverQueue) {
                ...
                if (playlist) return;
                let thing = new MessageEmbed()
                    .setAuthor("Song has been added to queue", "https://media.discordapp.net/attachments/832228029987946496/833329599412305930/MusicArrow.gif")
        ...
        async function play(guild, song) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://media.discordapp.net/attachments/832228029987946496/832946021382225930/gertgrth.gif")
                .setThumbnail(song.img)
                .setColor("BLUE")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
